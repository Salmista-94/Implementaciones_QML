...
Style {
    ...
    */
    property Component navigationBar: Rectangle {
        height: Math.round(TextSingleton.implicitHeight * 2.12)// old: 2.73; new: 2.12; other: 1.73
        color: "#f9f9f9"
        ...
        Label {
            ...
            font.pixelSize: TextSingleton.implicitHeight * 1.15// old: 1.25; new: 1.15;
            font.capitalization: Font.Capitalize// old: ...; new: font.capitalization: Font.Capitalize;
            anchors.verticalCenter: parent.verticalCenter
    ...
    */
    property Component dayDelegate: Rectangle {
        ...
        Label {
            ...
            font.pixelSize: Math.min(parent.height/2, parent.width/2)// old: /3; new: /2
            color: {
    ...
    */
    property Component dayOfWeekDelegate: Rectangle {
        ...
        implicitHeight: Math.round(TextSingleton.implicitHeight * 1.40)// old: 2.25; new: 1.40;
        Label {
    ...
    */
    property Component weekNumberDelegate: Rectangle {
        implicitWidth: Math.round(TextSingleton.implicitHeight * 1.35)// old: 2; new: 1.35;
        Label {
            text: styleData.weekNumber
            anchors.centerIn: parent
            color: "#666"// old: "#444"; new: "#666";
            font.bold: true;// old: ...; new: font.bold: true;
        }
    }
